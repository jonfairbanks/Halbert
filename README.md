...
![GitHub Workflow Status](<https://img.shields.io/github/workflow/status/jonfairbanks/Halbert/Create%20Release(s)?label=Docker%20Build>)
![GitHub top language](https://img.shields.io/github/languages/top/jonfairbanks/Halbert.svg)
![Docker Pulls](https://img.shields.io/docker/pulls/jonfairbanks/halbert.svg)
![GitHub last commit](https://img.shields.io/github/last-commit/jonfairbanks/Halbert.svg)
![Lines of code](https://img.shields.io/tokei/lines/github/jonfairbanks/Halbert)
